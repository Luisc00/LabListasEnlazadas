package ListasEnlazadas.ListasEnlazadasGenericas;
...
public class ListaDoble<T> implements Iterable<T> {
    ...
    public void agregarfinal(T valorNodo) {
        ...
        if (estaVacia()) {
            ...
            // Establecemos el nodo siguiente del nodo actualmente último al nuevo nodo
            nodoUltimo.setSiguienteNodo(nuevoNodo);
            // Establecemos el nodo anterior del nuevo nodo al nodo actualmente último
            nuevoNodo.setAnteriorNodo(nodoUltimo);
            // El nuevo nodo ahora es el último nodo en la lista
    ...
    /**
     * Agrega un valor en la lista en una posicion especfica
    ...
    public void setTamanio(int tamanixo) {
